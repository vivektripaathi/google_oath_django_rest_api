"""
Django settings for OrderlyAuth project.
...
SECRET_KEY = 'django-insecure-dfm6tbuux68@+g^1sy_ha03tytr6o!!u)xr8w2(&&*%dy*_0o1'
...
WSGI_APPLICATION = 'OrderlyAuth.wsgi.application'
...
db_from_env = env.db(default="psql://postgres:postgres@localhost:5432/orderly_auth_db")
